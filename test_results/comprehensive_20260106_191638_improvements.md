...
**Based on comprehensive test analysis of 1012 test cases**
**Detection Rate: 82.11%**

## 🚨 CRITICAL CLI FIXES REQUIRED

### 1. RDS Database Optimization (0/171 detected)
...
### 2. NAT Gateway Cost Analysis (0/105 detected)
...
### 3. Lambda Function Timeout Analysis (32/70 detected)
...
### 4. Security Group Complexity Analysis (0/99 detected)
...
### 5. ElastiCache Resource Analysis (0/60 detected)
...
### 7. Environment-Aware Optimization (0/387 dev/staging detected)
...
---
*Generated automatically from test results - Run ID: comprehensive_20260106_191638*
