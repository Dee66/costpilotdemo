...
### security_overhead Optimization Engine
- **Failure Rate:** 39/39 tests (100%)
- **Business Impact:** High - security_overhead is a common infrastructure pattern
- **Implementation:** Add pattern recognition for security_overhead resource types
...
*Run ID: comprehensive_20260106_181956*
